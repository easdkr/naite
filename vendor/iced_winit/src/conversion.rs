...
pub fn window_event(
    ...
    match event {
        ...
        WindowEvent::Ime(ime) => Some(Event::Ime(match ime {
            winit::event::Ime::Enabled => event::Ime::Enabled,
            winit::event::Ime::Preedit(text, cursor) => event::Ime::Preedit(text.clone(), cursor),
            winit::event::Ime::Commit(text) => event::Ime::Commit(text.clone()),
            winit::event::Ime::Disabled => event::Ime::Disabled,
        })),
