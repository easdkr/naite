    ...
    Renderer: core::Renderer + 'a,
{
        ...
        Renderer: core::Renderer,
    {
        ...
        fn on_event(
            ...
            if let core::event::Status::Captured = self.content.as_widget_mut().on_event(
...
where
    Message: 'a,
    Renderer: core::Renderer + core::text::Renderer<Font = core::Font> + core::svg::Renderer + 'a,
    Theme: text::Catalog + crate::svg::Catalog + 'a,
{
    ...
    static LOGO: Lazy<svg::Handle> =
        Lazy::new(|| svg::Handle::from_memory(include_bytes!("../assets/iced-logo.svg")));
