...
use crate::core::{Color, Element, Layout, Length, Point, Rectangle, Size, Theme, Vector, Widget};
use crate::Renderer;
    ...
    Theme: Catalog,
{
    ...
    fn layout(
        ...
        let side_length = (self.data.width + 2 * QUIET_ZONE) as f32 * f32::from(self.cell_size);
