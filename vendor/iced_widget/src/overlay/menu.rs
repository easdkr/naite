...
use crate::core::{
    Background, Clipboard, Color, Length, Padding, Pixels, Point, Rectangle, Size, Theme, Vector,
};
...
impl<'a, 'b, Message, Theme, Renderer> crate::core::Overlay<Message, Theme, Renderer>
