...
use crate::core::{
    Background, Clipboard, Color, Element, Layout, Length, Point, Rectangle, Shell, Size, Vector,
    Widget,
};
    ...
    Renderer: crate::core::Renderer,
{
    ...
    fn overlay<'b>(
        ...
        impl<'a, Message, Theme, NewTheme, Renderer> overlay::Overlay<Message, Theme, Renderer>
            ...
            Renderer: crate::core::Renderer,
        {
            ...
            fn draw(
                ...
                self.content
                    .draw(renderer, &(self.to_theme)(theme), style, layout, cursor);
            }
