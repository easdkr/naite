...
use crate::core::{self, Clipboard, Element, Layout, Point, Rectangle, Shell, Size, Vector};
    ...
    Renderer: core::Renderer,
{
    ...
    pub(crate) fn overlay<'b>(
        ...
        if let Some(title_bar) = self.title_bar.as_mut() {
            ...
            match title_bar.overlay(title_bar_state, title_bar_layout, renderer, translation) {
